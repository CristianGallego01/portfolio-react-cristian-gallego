...
export const Projects = () =>{
    return(
        ...
        <div className="projects-cards">
            ...
            <div className="description">
                <p>
                Proyecto en el cual se realiza un recorrido de arreglo para generar tarjetas de personajes
        ...
        <div className="projects-cards">
            ...
            <div className="description">
                <p>
                simulacion de sitio web en el cual se puso en practica el manejo de html y css visto en el trimestre
